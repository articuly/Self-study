                ...
                for item_dict in lst:
                    for k, v in item_dict.items():
                        if k == 'onebest':
                            s += v
                print(s)
                with open('xf_result.txt', 'a') as f:
                    f.write(s)
                    f.write('\n')
            except Exception:
                return result
...
if __name__ == '__main__':
    api = RequestApi(appid="5e9d06", secret_key="453641f6b00b033e65afecbe30d966b4",
                     upload_file_path=r"D:\Programing\python_projects\Self-study\audio\chunk001.wav")
    api.all_api_request()
